...
public class S2CGameRuleBooleanSimplePacket {
    ...
    private static Map<String, GameRules.Key<GameRules.BooleanRule>> GAMERULE_MAP = GET_ALL_RULES;
        ...
        ClientPlayNetworking.registerGlobalReceiver(ID,
                (payload, context) ->
                        context.client().execute(() -> {
                            ...
                            GameRules.Key<GameRules.BooleanRule> booleanRuleKey = GAMERULE_MAP.get(payload.rulesId);
